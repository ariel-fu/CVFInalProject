/**
 * Filename: HashTableADT.java Project: p3-2020 Course: cs400 Authors: Debra
 * Deppeler
 * 
 * May use any of these Java's built-in Java collection types: Arrays, List,
 * ArrayList, LinkedList, Stack, Queue (interface), PriorityQueue, Deque
 * 
 * May not use HashTable, TreeMap, HashMap, etc. May not add any public members
 * to ADT or your implementation.
 *
