/**
 * This class implements a LinkedNode data type for a linked linear data
 * structure
 * 
...
public class LinkedNode<T> {
  ...
  /**
   * Creates an instanceof LinkedNode with a given item. The created LinkedNode
   * has null as next field
   * 
