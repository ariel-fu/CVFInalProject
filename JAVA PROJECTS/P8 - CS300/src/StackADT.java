...
public interface StackADT<T> {
   ...
   * @throws java.util.IllegalArgumentException with a descriptive error message
   *                                            if the input element is null
   */
   ...
   * @throws java.util.EmptyStackException without error message if the stack is
   *                                       empty
   */
  public T pop();
