...
def test_players():
    ...
    while piece_count < 8 and ai.game_value(ai.board) == 0:
        ...
        if ai.my_piece == ai.pieces[turn]:
            ...
            # TEST
            # time_start = time.time()
            player_move = aiOpp.make_move(ai.board)
            ...
            print(aiOpp.my_piece+" moved at "+chr(player_move[0][1]+ord("A"))+str(player_move[0][0]))
...
def main():
    test_teeko2_player = None
    runs = 0
    wins = 0
    while runs < 1000:
        test_teeko2_player = test_players()
        wins += test_teeko2_player
        runs += 1
    
    print("total wins: ", wins)
    print("average: ", (wins/runs))
